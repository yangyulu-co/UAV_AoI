...
reward_data = np.loadtxt('Pretrained_model/PPO_reward_data.txt')
    # reward_data = np.loadtxt('Pretrained_model/PPO_saved_time_data.txt')
reward_temp = 0
reward_plot = []
interval = 1  # 绘图间隔
...
plt.savefig('./Pretrained_model/PPO_threhold_reward.png')
# plt.savefig('./Pretrained_model/PPO_threhold_saved_time.png')
plt.show()